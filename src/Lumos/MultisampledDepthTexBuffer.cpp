...
MultisampledDepthTexBuffer::MultisampledDepthTexBuffer()
{

}

MultisampledDepthTexBuffer::MultisampledDepthTexBuffer(const size_t & width, const size_t & height)
...
void MultisampledDepthTexBuffer::resize(const GLsizei & w, const GLsizei & h)
{
  use();
